package com.mateus.tds.controller;
...
public class MediaController {
	...
	void onClickBtnCalcular(ActionEvent event) {
		try {
			...
			if (media >= 7) {
				this.lblRecebeResultado.setText("O aluno está aprovado");
				this.lblRecebeResultado.setTextFill(Color.web("008000"));
			} else if(media < 7 && media >=5) {
				this.lblRecebeResultado.setText("O aluno ficou na recuperação, tem chance!");
				this.lblRecebeResultado.setTextFill(Color.web("0000ff"));
			} else {
				this.lblRecebeResultado.setText("O aluno está reprovado");
